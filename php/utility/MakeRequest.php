...
// Mockae SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class MockaeMakeRequest
{
    public static function call(MockaeContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new MockaeResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new MockaeResponse($fetched);
        } else {
