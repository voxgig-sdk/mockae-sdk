...
class MockaeTimeoutFeature extends MockaeBaseFeature
{
    ...
    private function _with_timeout(MockaeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MockaeContext $_ctx, float $ms): void
    {
        $client = $this->client;
