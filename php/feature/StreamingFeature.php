...
class MockaeStreamingFeature extends MockaeBaseFeature
{
    ...
    private function _iterate(MockaeResult $result): \Generator
    {
    ...
    private function _streamable(MockaeContext $ctx): bool
    {
