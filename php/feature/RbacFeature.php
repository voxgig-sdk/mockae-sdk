...
class MockaeRbacFeature extends MockaeBaseFeature
{
    ...
    private function _required(MockaeContext $ctx): ?string
    {
    ...
    private function _reject(MockaeContext $ctx, string $required): void
    {
    ...
    private function _track(MockaeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
