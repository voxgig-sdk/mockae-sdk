...
class MockaeProxyFeature extends MockaeBaseFeature
{
    ...
    public function init(MockaeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MockaeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
