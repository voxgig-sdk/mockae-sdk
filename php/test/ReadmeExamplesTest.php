...
// Mockae SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MockaeSDK::test)
...
{
    private const SDK_CLASS = 'MockaeSDK';
    ...
    private const SDK_BASE = 'mockae_sdk';
