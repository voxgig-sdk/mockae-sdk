...
class MockaeTestRunner
{
    ...
    {
        $live = self::getenv('MOCKAE_TEST_LIVE');
        $override = self::getenv('MOCKAE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('MOCKAE_TEST_EXPLAIN');
...
class_alias('MockaeTestRunner', 'Runner');
class_alias('MockaeHelpers', 'Helpers');
