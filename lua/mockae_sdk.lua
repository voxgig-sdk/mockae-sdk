...
MockaeSDK._make_feature = _make_feature


function MockaeSDK.new(options)
  local self = setmetatable({}, MockaeSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function MockaeSDK:options_map()
...
function MockaeSDK:get_utility()
  return Utility.copy(self._utility)
end


function MockaeSDK:get_root_ctx()
  return self._rootctx
end


function MockaeSDK:prepare(fetchargs)
...
function MockaeSDK:direct(fetchargs)
...
-- by passing it.
function MockaeSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function MockaeSDK:graphql(query, variables, ctrl)
...
function MockaeSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = MockaeSDK.new(sdkopts)
  sdk.mode = "test"
