...
-- data to return.
local TEST_SEED = '{ entity = { ["cart"] = { ["test01"] = { id = "test01" } }, ["coupon"] = { ["test01"] = { id = "test01" } }, ["product"] = { ["test01"] = { id = "test01" } }, ["status"] = { ["test01"] = { id = "test01" } }, ["user"] = { ["test01"] = { id = "test01" } } } }'
