...
describe("StatusEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set MOCKAE_TEST_STATUS_ENTID JSON to run live")
      return
    end
...
function status_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("MOCKAE_TEST_STATUS_ENTID")
