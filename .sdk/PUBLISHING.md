...
|---|---|---|
| `ts/` | @voxgig-sdk/mockae-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/mockae-sdk \
      --repository voxgig-sdk/mockae-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/mockae-sdk` shows it, and
`npm trust revoke @voxgig-sdk/mockae-sdk --id=<id>` removes it.
