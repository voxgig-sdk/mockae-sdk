...
from projectname_sdk.core.control import MockaeControl
...
class MockaeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, MockaeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return MockaeError(code, msg, self)
