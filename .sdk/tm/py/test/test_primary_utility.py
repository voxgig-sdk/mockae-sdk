...
from projectname_sdk import MockaeSDK
from projectname_sdk.core.spec import MockaeSpec
from projectname_sdk.core.result import MockaeResult
from projectname_sdk.core.response import MockaeResponse
from projectname_sdk.core.operation import MockaeOperation
from projectname_sdk.core.error import MockaeError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import MockaeBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = MockaeSDK.test(None, None)
        ...
        class TestInitFeature(MockaeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(MockaeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = MockaeSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = MockaeSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = MockaeSDK.test(None, setup_opts)
