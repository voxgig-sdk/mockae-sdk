...
class MockaeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MockaeSDK/1.0)';
    ...
    public static function call(MockaeContext $ctx, string $fullurl, array $fetchdef): array
    {
