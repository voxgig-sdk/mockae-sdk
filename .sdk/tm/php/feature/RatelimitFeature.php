...
class MockaeRatelimitFeature extends MockaeBaseFeature
{
    ...
    private function _acquire(MockaeContext $ctx): void
    {
    ...
    private function _track(MockaeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
