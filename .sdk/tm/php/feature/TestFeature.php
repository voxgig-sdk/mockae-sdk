...
// Mockae SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class MockaeTestFeature extends MockaeBaseFeature
{
    ...
    public function init(MockaeContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (MockaeContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (MockaeContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(MockaeContext $ctx, $op, $args): array
    {
