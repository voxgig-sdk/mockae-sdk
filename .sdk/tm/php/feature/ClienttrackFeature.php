...
// Mockae SDK clienttrack feature
...
class MockaeClienttrackFeature extends MockaeBaseFeature
{
    ...
    public function PostConstruct(MockaeContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Mockae-SDK';
