...
class MockaeCacheFeature extends MockaeBaseFeature
{
    ...
    private function _through(MockaeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
