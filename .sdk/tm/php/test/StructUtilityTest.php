...
// Mockae SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = MockaeOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(MockaeOmni::structfix($now, Struct::undef()))
                        !== json_encode(MockaeOmni::structfix($val, Struct::undef()))) {
