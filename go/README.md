...
The Golang SDK for the Mockae API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/mockae-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/mockae-sdk=../path/to/github.com/voxgig-sdk/mockae-sdk
```
...
| `User` | `(data map[string]any) MockaeEntity` | Create a User entity instance. |
...
```
github.com/voxgig-sdk/mockae-sdk/
...
The root package (`github.com/voxgig-sdk/mockae-sdk`) re-exports everything needed
