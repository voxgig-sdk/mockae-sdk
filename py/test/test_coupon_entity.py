...
class TestCouponEntity:
    ...
    def test_should_run_basic_flow(self):
        ...
        coupon_ref01_data_dt0_loaded = coupon_ref01_ent.load(coupon_ref01_match_dt0, None)
        coupon_ref01_data_dt0_load_result = helpers.to_map(runner.entity_data(coupon_ref01_data_dt0_loaded))
