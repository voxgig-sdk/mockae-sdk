# Mockae SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MockaeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MockaeSDK(...) and MockaeSDK.test(...) become
#      MockaeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "mockae_sdk"
_SDK_CLASS = "MockaeSDK"
