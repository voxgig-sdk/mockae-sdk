...
The Python SDK for the Mockae API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/mockae-sdk/releases)) or
...
| `expiryDate` | `str` | Coupon expiry date |
| `id` | `int` | Coupon ID |
| `type` | `str` | Type of discount (percentage or fixed) |
