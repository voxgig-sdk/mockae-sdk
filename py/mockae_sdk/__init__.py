...
from mockae_sdk.utility import register

# Load features
from mockae_sdk.feature.base_feature import MockaeBaseFeature
from mockae_sdk.features import _has_feature, _make_feature
...
class MockaeSDK:
    ...
    def get_utility(self):
        return MockaeUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MockaeSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Product(self, data=None) -> "ProductEntity":
        ...
        from mockae_sdk.entity.product_entity import ProductEntity
