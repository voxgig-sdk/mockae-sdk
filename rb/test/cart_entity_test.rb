...
class CartEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MOCKAE_TEST_CART_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def cart_basic_setup(extra)
  ...
  entid_env_raw = ENV["MOCKAE_TEST_CART_ENTID"]
