...
module MockaeTestRunner
  ...
  def self.env_override(m)
    live = getenv("MOCKAE_TEST_LIVE")
    override = getenv("MOCKAE_TEST_OVERRIDE")
    ...
    explain = getenv("MOCKAE_TEST_EXPLAIN")
    m["MOCKAE_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = MockaeTestRunner
Helpers = MockaeHelpers
Vs = VoxgigStruct
