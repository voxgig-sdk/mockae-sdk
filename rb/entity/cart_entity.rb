...
class CartEntity
  ...
  #   as an empty match, so client.Cart.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Cart, Hash] the loaded Cart; raises MockaeError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Cart>, Array] the matching Cart items; raises MockaeError on failure
