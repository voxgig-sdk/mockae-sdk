...
class ProductEntity
  ...
  # @return [Product, Hash] the loaded Product; raises MockaeError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Product>, Array] the matching Product items; raises MockaeError on failure
