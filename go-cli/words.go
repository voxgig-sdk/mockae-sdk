...
func registerSDKWords(r *eng.Registry, client *sdk.MockaeSDK) {
...
func runOp(client *sdk.MockaeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
