...
Mockae API allows you to create mock REST APIs with Lua code execution, enabling customization of headers, bodies, and HTTP status codes.

Learn more about Mockae API at [mockae.com](https://mockae.com).
...
This SDK exposes the API as a small set of **semantic entities** — Cart, Coupon, Product, Status and User — that you
