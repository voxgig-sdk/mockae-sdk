...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/mockae` | `npm install @voxgig-sdk/mockae` |
| Python | `voxgig-sdk-mockae` | `pip install voxgig-sdk-mockae` |
| PHP | `voxgig-sdk/mockae` | `composer require voxgig-sdk/mockae` |
| Golang | `github.com/voxgig-sdk/mockae-sdk/go` | `go get github.com/voxgig-sdk/mockae-sdk/go` |
| Ruby | `voxgig-sdk-mockae` | `gem install voxgig-sdk-mockae` |
| Lua | `voxgig-sdk-mockae` | `luarocks install voxgig-sdk-mockae` |
